...
import 'package:foodapp/pages/mess_component.dart';
import 'package:foodapp/pages/noti_component.dart';

class NotificationPage extends StatefulWidget {
  const NotificationPage({super.key});

  @override
  State<NotificationPage> createState() => _ServicesOrderState();
}

class _ServicesOrderState extends State<NotificationPage>
